...
export default class FooterTabs extends React.Component {
  ...
  handleTabPress(e){
    switch(e){
      case 0:
        this.setState({
          icon: ['home', 'people-outline', 'information-circle-outline']
        })
        this.props.navigation.navigate('home');
        break;
      case 1:
        this.setState({
          icon: ['home-outline', 'people', 'information-circle-outline']
        })
        this.props.navigation.navigate('pass');
        break;
      case 2:
        this.setState({
          icon: ['home-outline', 'people-outline', 'information-circle']
        })
  ...
  render(){
    return (
      <Footer style={{ backgroundColor: '#29235B', elevation: 5}}>
