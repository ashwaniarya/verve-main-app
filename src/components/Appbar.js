...
import {
  Header, Body, Title, Left, Right,Button,Icon,ActionSheet,
...
export default class AppBar extends React.Component{
  ...
  handleLeftPress(){
    ...
    if(this.props.left === 'arrow-back' || this.props.left === 'ios-arrow-back')
      return goBack()
  }
  ...
  render(){
    ...
    <Left>
      <Button transparent rounded
        ...
        <Icon name={this.props.left} style={{color: GLOBALS.primaryTitleColor}}/>
      </Button>
    </Left>
    ...
    <Right>
      {this.props.right === 'none' ? <Text />:
        <Button transparent rounded
          ...
          <Icon name={this.props.right} style={{color: GLOBALS.primaryTitleColor}}/>
        </Button>
      }
      {this.props.icon === 'none' ? <Text />:
        <Button transparent rounded
          onPress={this.handlePress.bind(this)}>
          <Icon name={this.props.icon} style={{color: GLOBALS.primaryTitleColor}}/>
        </Button>
      }
    </Right>
    ...
    return (
      <Header androidStatusBarColor={GLOBALS.primaryColorDark} style={styles.header}
        noShadow={this.props.noShadow} hasTabs={this.props.hasTabs}>
          {leftIcon}
          <Body>
            <Title style={{color: GLOBALS.primaryTitleColor}}>{this.props.title}</Title>
          </Body>
          {icon}
